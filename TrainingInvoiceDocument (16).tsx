...
export const TrainingInvoiceDocument: React.FC<TrainingInvoiceDocumentProps> = ({ contactsWithInvoices, settings, formData }) => {
      ...
      {contactsWithInvoices.map(({ contact, invoiceNumber }) => (
        <Page key={contact.id} size="A4" style={pdfStyles.page}>
          ...
          <View style={pdfStyles.metaBlock}>
            ...
            <Text style={{ marginTop: 5, color: '#000' }}>Rechnung Nr.: {invoiceNumber}</Text>
          </View>
